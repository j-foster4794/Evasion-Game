...
class Player(pygame.sprite.Sprite):
  ...
  def __init__(self):
    ...
    image = pygame.image.load("H:\James School Work\A Level\Comp Sci\Coding\Free time coding\Evasion Game\EvasionGamePlayer.png").convert()                 #Add new file
...
class enemy(pygame.sprite.Sprite):
  ...
  def __init__(self):
    pygame.sprite.Sprite.__init__(self)
    image = pygame.image.load("H:\James School Work\A Level\Comp Sci\Coding\Free time coding\Evasion Game\EvasionGameEnemy.png").convert()                     #Add new file
    image = pygame.transform.scale(image, (50, 50))
    self.surf = image
...
deathscreen = pygame.image.load("H:\James School Work\A Level\Comp Sci\Coding\Free time coding\Evasion Game\EvasionGameDeathScreen.png").convert()   # Add new file
